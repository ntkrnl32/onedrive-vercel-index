<div align="center">
  ...
  <a href="https://github.com/ntkrnl32/onedrive-vercel-index/discussions"><img src="https://img.shields.io/github/discussions/ntkrnl32/onedrive-vercel-index?color=CF2B5B&labelColor=black&logo=github" alt="GitHub Discussions" /></a>
</div>
...
Please go to our [discussion forum](https://github.com/ntkrnl32/onedrive-vercel-index/discussions) for general questions and FAQs, **issues are for bug reports and bug reports only.** Feature requests may or may not be ignored, since this project is **NOT** in active development.
...
> **Note**: This project is focused on showcasing and providing a way for others to download files from your OneDrive. Emphasis on **free** and **serverless**. If you have your own server / need WebDAV / use cloud providers other than OneDrive, checkout [openlist](https://oplist.org/).
